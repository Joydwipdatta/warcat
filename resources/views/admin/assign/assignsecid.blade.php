        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <h4 class="card-title font-weight-bold mb-3"><span class="text-primary m-2"> Name:</span>{{ $secretary->name }}</h4>

                    <form action="{{ route('update.secreatary.departement') }}" method="post" enctype="multipart/form-data">
                        @csrf
